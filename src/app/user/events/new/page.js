...
export default function NewEvent() {
	...
	return (
		...
		>
			<FormSection labelFor='title' sectionTitle={entitiesProperties.events.title}>
				<input id='title' name='title' type='text' required placeholder={entitiesProperties.events.title} onChange={(e) => { setTitle(e.target.value); }}></input>
			</FormSection>

			<FormSection labelFor='description' sectionTitle={entitiesProperties.events.description}>
				<textarea id='description' name='description' placeholder={entitiesProperties.events.description} onChange={(e) => { setDescription(e.target.value); }}></textarea>
			</FormSection>
